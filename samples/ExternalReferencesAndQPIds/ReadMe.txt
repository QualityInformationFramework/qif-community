...
example of a QPId is "dc5103a5-75da-4fc9-b5cf-ecf0f7eed9fd".
...
This file shows the use of a QPId at the top of the QIF document which uniquely
...
Files: 
              Exploded_Statistics.QIF
                 /	        \
   Exploded_Results1.QIF  Exploded_Results2.QIF
                 \              /
                  \            /
                 Exploded_Plan.QIF
...
mechanism begins by defining the file being referenced. For example, in
Exploded_Statistics.QIF:

  <ExternalQIFReferences n="2">
    <ExternalQIFDocument id="1">
      <QPId>C7523054-ADB7-47bb-AA6D-8B9B4AEC1556</QPId>
      <URI>.\Exploded_Results1.QIF</URI>
    </ExternalQIFDocument>
    <ExternalQIFDocument id="2">
      <QPId>FA4BF105-B04E-40f8-8493-5661CC5047DA</QPId>
      <URI>.\Exploded_Results2.QIF</URI>
    </ExternalQIFDocument>
...
In Exploded_Results1.QIF and Exploded_Results2.QIF:
...
...
*******************************************************************************
#4 Connecting QIF objects to objects outside QIF with UUIDs

Files: 
	QIF_Sphere.SLDPRT
	All-in-one.QIF

The characteristics in the QIF document may have UUIDs assigned:

      <SphericalDiameterCharacteristicItem id="5">
        <Name>SphericalDiameter1</Name>
	<CharacteristicDesignator>
          <Designator>W1RFTM</Designator>
	  <UUID>3D5D3273-55A6-4c38-9742-8B35E5D08914</UUID>
	</CharacteristicDesignator>
        <CharacteristicNominalId>3</CharacteristicNominalId>
      </SphericalDiameterCharacteristicItem>
