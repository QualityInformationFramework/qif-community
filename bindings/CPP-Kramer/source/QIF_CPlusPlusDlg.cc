...
// region Datum reference frames
  ...
  DatumWithPreced_1012_TypeVal * dwpA_Aval = new DatumWithPreced_1012_TypeVal();
  ...
  dwpA_A->setDatumWithPreced_1012
    (new DatumWithPreced_1012_Type(DwpA_Achoice));
...
// region A|B
  ...
  DatumWithPreced_1012_TypeVal * dwpA_ABval =
    new DatumWithPreced_1012_TypeVal();
  ...
  dwpA_AB->setDatumWithPreced_1012
    (new DatumWithPreced_1012_Type(DwpA_ABchoice));
  // add simple primary datum A to the datums list
  ...
  dwpB_AB->setDatumWithPreced_1012
    (new DatumWithPreced_1012_Type(DwpB_ABchoice));
...
// region A|B|C
  ...
  dwpA_ABC->setDatumWithPreced_1012
    (new DatumWithPreced_1012_Type(DwpA_ABCchoice));
  // add simple primary datum A to the datums list
  ...
  dwpB_ABC->setDatumWithPreced_1012
    (new DatumWithPreced_1012_Type(DwpB_ABCchoice));
  // add simple primary datum B to the datums list
  ...
  dwpC_ABC->setDatumWithPreced_1012
    (new DatumWithPreced_1012_Type(DwpC_ABCchoice));
...
// region Measurement devices
  ...
  cmm1Ref->setval(cmm1->getid()->getval());
  ...
  cmm2Ref->setval(cmm2->getid()->getval());
...
// region Datum A plane
  ...
  planANomRef->setval(planANom->getid()->getval());
  ...
  planAItemRef->setval(planAItem->getid()->getval());
  ...
  datAfeats->getId()->push_back(planANomRef);
  ...
  FlatnessCharact_1085_Type * flatDefLinear = new FlatnessCharact_1085_Type();
  flatDefLinear->setToleranceValue(flatZone);
  FlatnessCharact_1055_TypeVal * flatDefVal =
    new FlatnessCharact_1055_TypeVal();
  ...
  FlatnessCharact_1055_Type * flatDef1055 = new FlatnessCharact_1055_Type();
  ...
  flatItemFeatIds->getId()->push_back(planAItemRef);
  ...
  flatItemDevIds->getId()->push_back(cmm1Ref);
  flatItemDevIds->getId()->push_back(cmm2Ref);
  ...
  flatMeasDevIds->getId()->push_back(cmm2Ref);
...
// region datum B cylinder	
  ...
  cylBCDefRef->setval(cylBCDef->getid()->getval());
  ...
  cylBNomRef->setval(cylBNom->getid()->getval());
  ...
  cylBItemRef->setval(cylBItem->getid()->getval());
  ...
  datBfeats->getId()->push_back(cylBNomRef);
  ...
  LinearTolerance_1041_Type * minBCTol = new LinearTolerance_1041_Type();
  minBCTol->setMinValue(minusTolBC);
  LinearTolerance_1034_Type * maxMinBCTol = new LinearTolerance_1034_Type();
  maxMinBCTol->setMaxValue(plusTolBC);
  maxMinBCTol->setLinearTolerance_1041(minBCTol);
  LinearTolerance_1017_TypeVal * diaBCTolVal =
    new LinearTolerance_1017_TypeVal();
  ...
  LinearTolerance_1017_TypeChoicePair * diaBCTolChoice =
    ...
    (LinearTolerance_1017_TypeChoicePair::LinearTolerance_1034E,
     *diaBCTolVal);
  LinearTolerance_1017_Type * diaBCTol1017 = new LinearTolerance_1017_Type();
  ...
  DiameterCharact_1054_TypeVal * diaBCTolSelVal =
    new DiameterCharact_1054_TypeVal();
  ...
  DiameterCharact_1054_TypeChoicePair * diaBCTolSelChoice =
    ...
    (DiameterCharact_1054_TypeChoicePair::ToleranceE,
     *diaBCTolSelVal);
  DiameterCharact_1054_Type * diaBCTolSel = new DiameterCharact_1054_Type();
  ...
  diaBCNomRef->setval(diaBCNom->getid()->getval());
  ...
  diaBFeatIds->getId()->push_back(cylBItemRef);
  ...
  diaBDevIds->getId()->push_back(cmm1Ref);
  diaBDevIds->getId()->push_back(cmm2Ref);
  ...
  // point measured tolerance at measured feature
  QIFReferenceFullType * cylBMeasRef = new QIFReferenceFullType();
  cylBMeasRef->setval(cylBMeas->getid()->getval());
  ...
  diaBFeatMeasIds->getId()->push_back(cylBMeasRef);
  ...
  diaBMeasDevIds->getId()->push_back(cmm2Ref);
  ...
  perpItemIds->getId()->push_back(cylBItemRef); // from hooking to diameter
  ...
  perpItemDevIds->getId()->push_back(cmm1Ref);
  perpItemDevIds->getId()->push_back(cmm2Ref);
  ...
  perpMeasFeatIds->getId()->push_back(cylBMeasRef);
  ...
  perpMeasDevIds->getId()->push_back(cmm2Ref);
...
// region datum C cylinder
  ...
  cylCNomRef->setval(cylCNom->getid()->getval());
  ...
  cylCItemRef->setval(cylCItem->getid()->getval());
  ...
  datCfeats->getId()->push_back(cylCNomRef);
  ...
  diaCFeatIds->getId()->push_back(cylCItemRef);
  ...
  diaCDevIds->getId()->push_back(cmm1Ref);
  diaCDevIds->getId()->push_back(cmm2Ref);
  ...
  // point measured tolerance at measured feature
  QIFReferenceFullType * cylCMeasRef = new QIFReferenceFullType();
  cylCMeasRef->setval(cylCMeas->getid()->getval());
  ...
  diaCFeatMeasIds->getId()->push_back(cylCMeasRef);
  ...
  diaCMeasDevIds->getId()->push_back(cmm2Ref);
  ...
  posCItemFeatIds->getId()->push_back(cylCItemRef); // from diameter hook above
  ...
  posCItemDevIds->getId()->push_back(cmm1Ref);
  posCItemDevIds->getId()->push_back(cmm2Ref);
  ...
  posCMeasFeatIds->getId()->push_back(cylCMeasRef);
  ...
  posCMeasDevIds->getId()->push_back(cmm2Ref);
...
// region circle back to ABC
  ...
  circItemRef->setval(circItem->getid()->getval());
  ...
  LinearTolerance_1041_Type * minDiaTol = new LinearTolerance_1041_Type();
  minDiaTol->setMinValue(lowSize);
  LinearTolerance_1034_Type * maxMinDiaTol = new LinearTolerance_1034_Type();
  ...
  LinearTolerance_1017_TypeChoicePair * diaDiaTolChoice =
    ...
    (LinearTolerance_1017_TypeChoicePair::LinearTolerance_1034E,
     *diaDiaTolVal);
  LinearTolerance_1017_Type * diaDiaTol1017 = new LinearTolerance_1017_Type();
  ...
  DiameterCharact_1054_TypeChoicePair * diaDiaTolSelChoice =
    ...
    (DiameterCharact_1054_TypeChoicePair::ToleranceE,
     *diaDiaTolSelVal);
  DiameterCharact_1054_Type * diaDiaTolSel = new DiameterCharact_1054_Type();
  ...
  diaItemFeatIds->getId()->push_back(circItemRef);
  ...
  diaItemDevIds->getId()->push_back(cmm1Ref);
  diaItemDevIds->getId()->push_back(cmm2Ref);
  ...
  QIFReferenceFullType * circMeasRef = new QIFReferenceFullType();
  circMeasRef->setval(circMeas->getid()->getval());
  ...
  diaMeasFeatIds->getId()->push_back(circMeasRef);
  ...
  diaMeasDevIds->getId()->push_back(cmm2Ref);
  ...
  posItemFeatIds->getId()->push_back(circItemRef); // from diameter
  ...
  posItemDevIds->getId()->push_back(cmm1Ref);
  posItemDevIds->getId()->push_back(cmm2Ref);
  ...
  posMeasFeatIds->getId()->push_back(circMeasRef);
  ...
  posMeasDevIds->getId()->push_back(cmm2Ref);
...
// region QIF document
 ...
 //remove shared references, leaving one; shared references cause delete crash
  cylBNom->setFeatureDefinitionId(0);
  planAItem->setFeatureNominalId(0);
  cylBItem->setFeatureNominalId(0);
  cylCItem->setFeatureNominalId(0);
  diaCItem->setCharacteristicNominalId(0);
  cylBMeas->setFeatureItemId(0);
  diaBFeatIds->getId()->remove(cylBItemRef);
  cylCMeas->setFeatureItemId(0);
  diaCFeatIds->getId()->remove(cylCItemRef);
  planAMeas->setFeatureItemId(0);
  circMeas->setFeatureItemId(0);
  diaItemFeatIds->getId()->remove(circItemRef);
  diaBCNom->setTargetValue(0);
  diaBDevIds->getId()->remove(cmm1Ref);
  diaBDevIds->getId()->remove(cmm2Ref);
  perpItemDevIds->getId()->remove(cmm1Ref);
  perpItemDevIds->getId()->remove(cmm2Ref);
  diaCDevIds->getId()->remove(cmm1Ref);
  diaCDevIds->getId()->remove(cmm2Ref);
  posCItemDevIds->getId()->remove(cmm1Ref);
  posCItemDevIds->getId()->remove(cmm2Ref);
  diaItemDevIds->getId()->remove(cmm1Ref);
  diaItemDevIds->getId()->remove(cmm2Ref);
  posItemDevIds->getId()->remove(cmm1Ref);
  posItemDevIds->getId()->remove(cmm2Ref);
  flatMeasDevIds->getId()->remove(cmm2Ref);
  diaBMeasDevIds->getId()->remove(cmm2Ref);
  perpMeasDevIds->getId()->remove(cmm2Ref);
  diaCMeasDevIds->getId()->remove(cmm2Ref);
  posCMeasDevIds->getId()->remove(cmm2Ref);
  diaMeasDevIds->getId()->remove(cmm2Ref);
  posMeasDevIds->getId()->remove(cmm2Ref);
  perpMeasFeatIds->getId()->remove(cylBMeasRef);
  posCMeasFeatIds->getId()->remove(cylCMeasRef);
